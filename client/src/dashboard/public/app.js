import { TRANSLATIONS, PLUGIN_NAME_TRANSLATIONS } from './js/translations.js';
import { NOISY_PACKETS, MAX_ROWS, MAX_PLUGIN_LOGS, CLASS_NAMES, CLASS_COLORS, SKIN_COLOR, SKIN_SHADOW, EAM_ASSETS, EAM_ITEMS, EAM_ENCHANTMENTS, ITEM_RARITY_ICONS, THEMES, LANGUAGES, SPRITE_TEMPLATE } from './js/constants.js';
